<template>
  <div class="maintainRecord">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          <li>{{"维护记录名称:"+"&#12288;"+detail.name}}</li>
          <li>{{"维护记录编码:"+"&#12288;"+detail.code}}</li>
          <li>{{"状态:"+"&#12288;"+detail.state}}</li>
          <li>{{"类型名称:"+"&#12288;"+type.name}}</li>
          <li>{{"类型编码:"+"&#12288;"+type.code}}</li>
          <li>{{"类型状态:"+"&#12288;"+type.state}}</li>
          <li>{{"设备名称:"+"&#12288;"+equipment.name}}</li>
          <li>{{"设备编码:"+"&#12288;"+equipment.code}}</li>
          <li>{{"设备信息状态:"+"&#12288;"+equipment.state}}</li>
          <li>{{"维护结果:"+"&#12288;"+detail.result}}</li>
          <li>{{"维护人员:"+"&#12288;"+detail.handler}}</li>
          <li>{{"维护时间:"+"&#12288;"+detail.dataTime}}</li>
          <li>{{"维护耗时:"+"&#12288;"+detail.time_consuming}}</li>
        ...
        <Collapse active-key="3" accordion v-if="detail.parts_use!==undefined && detail.parts_use.length > 0">
          备品消耗信息:
          <Panel >
            <div  slot="content">
              <table >
