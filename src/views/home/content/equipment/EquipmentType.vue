<template>
  <div class="equipmentType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加设备分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
...
<!--          <div class="item" v-show ="detail.equipmentType_item!==undefined && detail.equipmentType_item.length > 0">-->
<!--            <dt>包含内容</dt>-->
<!--            <table >-->
