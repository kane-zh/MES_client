    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          ...
          <li v-if="attribute_title.attribute6!==''">{{attribute_title.attribute1 +":"+"&#12288;"+detail.attribute1}}</li>
          <li v-if="attribute_title.attribute7!==''">{{attribute_title.attribute2 +":"+"&#12288;"+detail.attribute2}}</li>
          <li v-if="attribute_title.attribute8!==''">{{attribute_title.attribute3 +":"+"&#12288;"+detail.attribute3}}</li>
          <li v-if="attribute_title.attribute9!==''">{{attribute_title.attribute4 +":"+"&#12288;"+detail.attribute4}}</li>
          <li v-if="attribute_title.attribute10!==''">{{attribute_title.attribute5 +":"+"&#12288;"+detail.attribute5}}</li>
