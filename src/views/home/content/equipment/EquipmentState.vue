            ...
            <table >
              ...
              <tr align="center" v-for="(item,index) in list" :key="item.id" type="height:1em" >
                ...
                <td>
                  ...
                  <button type="button" @click="showUpdateView(item.id)">更改</button>
                </td>
              </tr>
              <tr>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          ...
          <li>{{"加工数量:"+"&#12288;"+detail.sum}}</li>
          <li>{{"任务编码:"+"&#12288;"+detail.task}}</li>
          <li>{{"稼动率:"+"&#12288;"+detail.util_rate}}</li>
          <li>{{"完成率:"+"&#12288;"+detail.comp_rate}}</li>
          ...
          <li v-show ="attribute_title.attribute6!==''">{{attribute_title.attribute1 +":"+"&#12288;"+detail.attribute1}}</li>
          <li v-show ="attribute_title.attribute7!==''">{{attribute_title.attribute2 +":"+"&#12288;"+detail.attribute2}}</li>
          <li v-show ="attribute_title.attribute8!==''">{{attribute_title.attribute3 +":"+"&#12288;"+detail.attribute3}}</li>
          <li v-show ="attribute_title.attribute9!==''">{{attribute_title.attribute4 +":"+"&#12288;"+detail.attribute4}}</li>
          <li v-show ="attribute_title.attribute10!==''">{{attribute_title.attribute5 +":"+"&#12288;"+detail.attribute5}}</li>
