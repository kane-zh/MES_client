<template>
  <div class="equipmentInfor">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          <li>{{"设备台账名称:"+"&#12288;"+detail.name}}</li>
          <li>{{"设备台账编码:"+"&#12288;"+detail.code}}</li>
          <li>{{"状态:"+"&#12288;"+detail.state}}</li>
          <li>{{"类型名称:"+"&#12288;"+type.name}}</li>
          <li>{{"类型编码:"+"&#12288;"+type.code}}</li>
          <li>{{"类型状态:"+"&#12288;"+type.state}}</li>
          <li v-if="vendor!==null">{{"厂商名称:"+"&#12288;"+vendor.name}}</li>
          <li v-if="vendor!==null">{{"厂商编码:"+"&#12288;"+vendor.code}}</li>
          <li v-if="vendor!==null">{{"厂商状态:"+"&#12288;"+vendor.state}}</li>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>设备编码:
          <input v-model="formItem.code"  placeholder="请输入设备编码...">
