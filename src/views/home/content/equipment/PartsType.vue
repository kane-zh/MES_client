<template>
  <div class="partsType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加备品分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
...
<!--          <div class="item" v-show ="detail.partsType_item!==undefined && detail.partsType_item.length > 0">-->
<!--            <dt>包含内容</dt>-->
<!--            <table >-->
...
export default {
  ...
  mounted () {
    this.attach_attributes = this.$store.getters.getConfig.attach_attribute.备品信息
  },
  computed: {
    username () {
