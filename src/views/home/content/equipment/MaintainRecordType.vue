<template>
  <div class="maintainRecordType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加维护记录分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
...
<!--          <div class="item" v-show ="detail.maintainRecordType_item!==undefined && detail.maintainRecordType_item.length > 0">-->
<!--            <dt>包含内容</dt>-->
<!--            <table >-->
...
export default {
  ...
  mounted () {
    this.attach_attributes = this.$store.getters.getConfig.attach_attribute.维护记录信息
  },
  computed: {
    username () {
