<template>
  <div class="assessmentType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加考核分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="center">
        ...
        <div class="content">
          ...
          <div class="item" v-if="detail.assessmentType_item!==undefined && detail.assessmentType_item.length > 0">
            <dt>包含内容</dt>
            <table >
...
export default {
  ...
  mounted () {
    this.attach_attributes = this.$store.getters.getConfig.attach_attribute.考核
  },
  computed: {
    username () {
