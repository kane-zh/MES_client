  ...
  <div class="stationInfor">
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>
          <button type="button" @click="showChildForm='material'" >添加物料</button>
        </div>
        <div v-show="showChildForm==='material'" class="child">
          <form>
            ...
            <div>
              ...
              <button type="button" @click="showChildForm=''">取消</button>
            </div>
          </form>
        </div>
        ...
        <div>
          <button type="button" @click="showChildForm='semifinished'" >添加半成品</button>
        </div>
        <div v-show="showChildForm==='semifinished'" class="child">
          <form>
              ...
              <div>备注信息:
                <textarea v-model="formItem_semifinished.desc" placeholder="请输入当前物料说明信息..."></textarea>
              </div>
              <div>
