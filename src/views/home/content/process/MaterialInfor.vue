      ...
      <div class="center">
        ...
        <div class="content">
          <form >
              ...
              <div >采购编码1:
                <input v-model="formItem.purchase_code1"  placeholder="请输入采购编码...">
              </div>
              <div >次级供应商:
              ...
              <div >采购编码2:
                <input v-model="formItem.purchase_code2"  placeholder="请输入采购编码...">
              </div>
              <div >备选供应商:
              ...
              <div >采购编码3:
                <input v-model="formItem.purchase_code3"  placeholder="请输入采购编码...">
              </div>
  ...
  methods: {
    ...
    showUpdateView (id) {
      ...
      this.$axios.get(`process/materialInfor/` + id).then(function (response) {
        ...
        self.formItem.character = response.data.character
