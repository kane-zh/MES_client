<template>
  <div class="productRouteType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加生产路线分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="center">
        ...
        <div class="content">
          ...
          <div class="item" v-if="detail.productRouteType_item!==undefined && detail.productRouteType_item.length > 0">
            <dt>包含内容</dt>
            <table >
