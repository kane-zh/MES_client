<template>
  <div class="eventType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加事件分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="center">
        ...
        <div class="content">
          ...
          <div class="item" v-if="detail.eventType_item!==undefined && detail.eventType_item.length > 0">
            <dt>包含内容</dt>
            <table >
...
export default {
  ...
  mounted () {
    this.attach_attributes = this.$store.getters.getConfig.attach_attribute.事件
  },
  computed: {
    username () {
