  ...
  <div class="vendorInfor">
    ...
    <div  class="list"  v-if="showViewid==='list'">
      <div class="listHead">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加设备供应商</button>
        </div>
        <div class="ordering">
          <div>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          <li>{{"设备供应商名称:"+"&#12288;"+detail.name}}</li>
          <li>{{"设备供应商编码:"+"&#12288;"+detail.code}}</li>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>供应商编码:
          <input v-model="formItem.code"  placeholder="请输入供应商编码...">
        ...
        <div>供应商电话:
          <input v-model="formItem.mobile"  placeholder="请输入供应商电话...">
        </div>
        <div>供应商传真:
          <input v-model="formItem.fax"  placeholder="请输入供应商传真...">
        </div>
        <div>供应商微信:
          <input v-model="formItem.wechat"  placeholder="请输入供应商微信...">
        </div>
        <div>供应商公司全称:
          <input v-model="formItem.company_name"  placeholder="请输入供应商公司全称...">
        </div>
        <div>供应商公司简称:
          <input v-model="formItem.company_abbre"  placeholder="请输入供应商公司简称...">
        </div>
        <div>供应商公司资质:
          <input v-model="formItem.qualification"  placeholder="请输入供应商公司资质...">
        </div>
...
export default {
  ...
  methods: {
    ...
    showUpdateView (id) {
      ...
      this.$axios.get(`plan/vendorInfor/` + id).then(function (response) {
        ...
        self.formItem.qualification = response.data.qualification
    ...
    save () {
      ...
      this.$axios.post(`plan/vendorInfor/`, {
        ...
        qualification: self.formItem.qualification,
    ...
    update () {
      ...
      this.$axios.put(`plan/vendorInfor/` + self.formItem.id + '/', {
        name: self.formItem.name,
        code: self.formItem.code,
        type: self.formItem.type,
        address: self.formItem.address,
    ...
    saveAndSubmit () {
      ...
      this.$axios.post(`plan/vendorInfor/`, {
        ...
        self.formItem.image = []
        self.imageData = []
        self.$axios.patch(`plan/vendorInfor/` + response.data.id + '/', {
          state: '审核中'
        }).then(function (response
        ) {
          alert('数据提交成功')
  ...
  watch: {
    ...
    'formItem.type': function (newval, oldval) {
      ...
      this.$axios.get(`plan/vendorType/` + newval).then(function (response) {
