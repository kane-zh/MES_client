<template>
  <div class="semifinishedTaskType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加半成品生产任务分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
...
<!--          <div class="item" v-show ="detail.semifinishedTaskType_item!==undefined && detail.semifinishedTaskType_item.length > 0">-->
<!--            <dt>包含内容</dt>-->
<!--            <table >-->
...
export default {
  ...
  mounted () {
    this.attach_attributes = this.$store.getters.getConfig.attach_attribute.半成品生产任务
  },
  computed: {
    username () {
