  ...
  <div class="semifinishedManagePlan">
    ...
    <div  class="list"  v-if="showViewid==='list'">
      <div class="listHead">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加半成品管理计划</button>
        </div>
        <div class="ordering">
          <div>
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('plan/semifinishedManagePlan/?ordering=' + self.ordering).then(function (response) {
    ...
    save () {
      ...
      this.$axios.post(`plan/semifinishedManagePlan/`, {
    ...
    update () {
      ...
      this.$axios.put(`plan/semifinishedManagePlan/` + self.formItem.id + '/', {
        name: self.formItem.name,
        code: self.formItem.code,
        type: self.formItem.type,
        file: self.formItem.file,
    ...
    saveAndSubmit () {
      ...
      this.$axios.post(`plan/semifinishedManagePlan/`, {
        ...
        self.formItem.file = []
        self.fileData = []
        self.$axios.patch(`plan/semifinishedManagePlan/` + response.data.id + '/', {
          state: '审核中'
        }).then(function (response
        ) {
          alert('数据提交成功')
