  ...
  <div class="salesOrderCreate">
    ...
    <div  class="list">
      <div class="heard">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加生产订单</button>
        </div>
      </div>
      <div class="content">
        <div class="table">
          ...
          <div class="child">
            ...
            <table v-show="list_child.length>0">
              ...
              <tr align="center" v-for="(item,index) in list_child" :key="item.id" >
                ...
                <td>{{item.state}}</td>
                <td>
                  <span  @click="endChild(item.id)" v-show="item.state!=='终止'">终止</span>
                </td>
              </tr>
              <tr>
...
export default {
  ...
  mounted () {
    this.attribute_title = this.$store.getters.getConfig.attach_attribute.生产订单
    this.attribute_title_child = this.$store.getters.getConfig.attach_attribute.生产订单子项
  },
  computed: {
    username () {
