  ...
  <div class="inspectionReport">
    ...
    <div  class="list">
      <div class="heard">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加汇报信息</button>
        </div>
      </div>
      <div class="content">
        <div class="table">
       ...
       <div class="heard">
        ...
        <div class="content">
          <div class="basic">
            ...
            <dd>{{"不合格数量:"+"&#12288;"+detail.ng_sum}}</dd>
            <dd>{{"让步接收数量:"+"&#12288;"+detail.concession_sum}}</dd>
            <dd>{{"抽检结果:"+"&#12288;"+detail.result}}</dd>
            <dd>{{"抽检人员:"+"&#12288;"+detail.handler}}</dd>
            <dd>{{"抽检时间:"+"&#12288;"+detail.dataTime}}</dd>
      ...
      <div class="center">
        ...
        <div class="content">
          <form >
            ...
            <div>检验结果:
              <select v-model="formItem.result"  placeholder="请选择结果"   >
      ...
      this.$axios.get(`quality/inspectionReport/` + id).then(function (response) {
        ...
        response.data.child.forEach(function (value, i) {
          var obj1 = {'id': value.id,
            ...
            'defectCode': value.defect.code,
            'defectTypeName': value.defect.type.name,
            'defectTypeCode': value.defect.type.code,
            'ok_sum': value.ok_sum,
            'ng_sum': value.ng_sum,
    ...
    uploadChild () {
      ...
      this.$axios.post(`quality/inspectionReportItem/`, {
        ...
        var obj = {
          ...
          'defectTypeName': self.defectInfor[index].type.name,
          'defectTypeCode': self.defectInfor[index].type.code,
