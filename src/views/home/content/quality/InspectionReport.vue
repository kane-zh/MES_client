    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          ...
          <li>{{"报检数量:"+"&#12288;"+detail.submit_sum}}</li>
          <li>{{"抽检数量:"+"&#12288;"+detail.samples_sum}}</li>
          <li>{{"合格数量:"+"&#12288;"+detail.ok_sum}}</li>
          <li>{{"不合格数量:"+"&#12288;"+detail.ng_sum}}</li>
          <li>{{"让步接收数量:"+"&#12288;"+detail.concession_sum}}</li>
          <li>{{"抽检结果:"+"&#12288;"+detail.result}}</li>
          <li>{{"抽检人员:"+"&#12288;"+detail.handler}}</li>
          <li>{{"抽检时间:"+"&#12288;"+detail.dataTime}}</li>
