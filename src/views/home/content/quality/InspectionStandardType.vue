<template>
  <div class="inspectionStandardType">
    ...
    <div  class="list">
      ...
      <div class="button">
        <button type="button" @click="showCreatView"  v-show="canCreate===true">添加质检标准分类</button>
      </div>
    </div>
    <!-- 详情页显示-->
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="center">
        ...
        <div class="content">
          ...
          <div class="item" v-if="detail.inspectionStandardType_item!==undefined && detail.inspectionStandardType_item.length > 0">
            <dt>包含内容</dt>
            <table >
...
export default {
  ...
  mounted () {
    this.attach_attributes = this.$store.getters.getConfig.attach_attribute.检验标准信息
  },
  computed: {
    username () {
