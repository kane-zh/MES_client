  ...
  <div class="defectGrade">
    ...
    <div  class="list">
      <div class="heard">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加缺陷等级信息</button>
        </div>
      </div>
      <div class="content">
        <div class="table">
      ...
      <div class="center">
        ...
        <div class="content">
          <div class="basic">
            ...
            <dd>{{"认证规则:"+"&#12288;"+detail.rule}}</dd>
            <dd>{{"不良影响:"+"&#12288;"+detail.influences}}</dd>
            <dd>{{"处理方式:"+"&#12288;"+detail.processing_method}}</dd>
        ...
        <div class="content">
          <form >
            ...
            <div>认证规则:
              ...
              <span class="message" v-show ="!$v.formItem.rule.required">请输入认证规则</span>
            </div>
            <div>不良影响:
              <textarea v-model="formItem.influences"  placeholder="请输入此等级不良影响..."></textarea>
              <span class="message" v-show ="!$v.formItem.influences.required">请输入不良影响</span>
            </div>
            <div>处理方式:
              <textarea v-model="formItem.processing_method"  placeholder="请输入此等级下检验品处理方式..."></textarea>
              <span class="message" v-show ="!$v.formItem.processing_method.required">请输入处理方式</span>
            </div>
