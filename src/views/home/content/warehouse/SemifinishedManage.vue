<template>
  <div class="semifinishedManage">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          <li>{{"半成品管理名称:"+"&#12288;"+detail.name}}</li>
          <li>{{"半成品管理编码:"+"&#12288;"+detail.code}}</li>
          ...
          <li>{{"物料类型编码:"+"&#12288;"+detail.semifinishedType_code}}</li>
          <li>{{"物料类型名称:"+"&#12288;"+detail.semifinishedType_name}}</li>
          <li>{{"物料编码:"+"&#12288;"+detail.semifinished_code}}</li>
          <li>{{"物料名称:"+"&#12288;"+detail.semifinished_name}}</li>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>半成品类型:
          <select v-model="formItem.semifinishedType"   placeholder="请选择半成品类型"      :disabled="inputDisable">
        ...
        <div>半成品:
          ...
          <span class="message" v-if="!$v.formItem.semifinished.required">请选择半成品</span>
        </div>
        <div>批次:
    ...
    <div  class="update"  v-show="showViewid==='update'">
      <form >
        ...
        <div>半成品类型:
          <select v-model="formItem.semifinishedType"   placeholder="请选择半成品类型"      :aria-disabled="inputDisable">
            <option v-for="item in semifinishedType" :value="item.id" :key="item.id">{{item.name+"("+item.code+")"}}</option>
          </select>
        </div>
        <div>半成品:
          <select v-model="formItem.semifinished"   placeholder="请选择半成品"     :aria-disabled="inputDisable">
            <option v-for="item in semifinishedInfor" :value="item.id" :key="item.id">{{item.name+"("+item.code+")"}}</option>
          </select>
          <span class="message" v-if="!$v.formItem.semifinished.required">请选择半成品</span>
        </div>
