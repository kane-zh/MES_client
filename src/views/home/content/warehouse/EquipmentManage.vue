      ...
      <div class="center">
        ...
        <div class="content">
          <div class="basic">
            ...
            <dd>{{"设备分类:"+"&#12288;"+detail.equipmentType_name+"("+detail.equipmentType_code+")"}}</dd>
            <dd>{{"设备:"+"&#12288;"+detail.equipment_code+"("+detail.equipment_name+")"}}</dd>
  ...
  methods: {
    ...
    showUpdateView (id) {
      ...
      this.$axios.get(`warehouse/equipmentManage/` + id).then(function (response) {
        ...
        self.formItem.equipment = response.data.equipment_id
