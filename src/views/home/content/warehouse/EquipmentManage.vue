<template>
  <div class="equipmentManage">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          <li>{{"设备管理名称:"+"&#12288;"+detail.name}}</li>
          <li>{{"设备管理编码:"+"&#12288;"+detail.code}}</li>
          ...
          <li>{{"设备类型编码:"+"&#12288;"+detail.equipmentType_code}}</li>
          <li>{{"设备类型名称:"+"&#12288;"+detail.equipmentType_name}}</li>
          <li>{{"设备编码:"+"&#12288;"+detail.equipment_code}}</li>
          <li>{{"设备名称:"+"&#12288;"+detail.equipment_name}}</li>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>设备:
          ...
          <span class="message" v-if="!$v.formItem.auditor.equipment">请选择设备</span>
        </div>
        <div>操作者:
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('warehouse/equipmentManage/?ordering=' + self.ordering).then(function (response) {
