<template>
  <div class="materialWaringRule">
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          <li>{{"物料库存预警名称:"+"&#12288;"+detail.name}}</li>
          <li>{{"物料库存预警编码:"+"&#12288;"+detail.code}}</li>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        <div>物料预警规则名称:
          <input v-model="formItem.name"  placeholder="请输入物料预警规则名称...">
        </div>
        <div>物料预警规则编码:
          <input v-model="formItem.code"  placeholder="请输入物料预警规则编码...">
    ...
    uploadChild () {
      ...
      this.$axios.post(`warehouse/materialWaringRuleItem/`, {
        ...
        for (var k = 0; k < self.warehouseInfor.length; k++) {
          if (self.materialType[k].code === self.formItem_child.warehouse) {
            index2 = k
            break
          }
        }
        var obj = {
          ...
          'materialTypCode': self.materialType[index1].code,
