  ...
  <div class="productManage">
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>产品类型:
          <select v-model="formItem.productType"   placeholder="请选择产品类型"      :disabled="inputDisable">
    ...
    <div  class="update"  v-show="showViewid==='update'">
      <form >
        ...
        <div>产品类型:
          <select v-model="formItem.productType"   placeholder="请选择产品类型"      :aria-disabled="inputDisable">
            <option v-for="item in productType" :value="item.id" :key="item.id">{{item.name+"("+item.code+")"}}</option>
          </select>
        </div>
        <div>产品:
