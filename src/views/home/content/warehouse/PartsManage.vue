       ...
       <div class="heard">
        ...
        <div class="content">
          <div class="basic">
            ...
            <dd>{{"备品分类:"+"&#12288;"+detail.partsType_name+"("+detail.partsType_code+")"}}</dd>
            <dd>{{"备品:"+"&#12288;"+detail.parts_code+"("+detail.parts_name+")"}}</dd>
  ...
  methods: {
    ...
    showUpdateView (id) {
      ...
      this.$axios.get(`warehouse/partsManage/` + id).then(function (response) {
        ...
        self.formItem.position = response.data.position_id
        self.formItem.parts = response.data.parts_id
