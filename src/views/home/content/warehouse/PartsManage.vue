  ...
  <div class="partsManage">
          ...
          <div class="table">
            <table >
              ...
              <tr align="center" v-for="(item,index) in list" :key="item.id" type="height:1em" >
                ...
                <td>{{item.code}}</td>
                <td>{{item.state}}</td>
                <td>{{item.parts_name+"("+item.parts_code+")"}}</td>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      <div class="content">
        <ul>
          ...
          <li>{{"备品分类:"+"&#12288;"+detail.partsType_name+"("+partsType_code+")"}}</li>
          <li>{{"备品:"+"&#12288;"+detail.parts_code+"("+parts_name+")"}}</li>
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        ...
        <div>备品分类:
          <select v-model="formItem.partsType"   placeholder="请选择备品分类"      :disabled="inputDisable">
    ...
    <div  class="update"  v-show="showViewid==='update'">
      <form >
        ...
        <div>备品分类:
          <select v-model="formItem.partsType"   placeholder="请选择备品分类"      :aria-disabled="inputDisable">
            <option v-for="item in partsType" :value="item.id" :key="item.id">{{item.name+"("+item.code+")"}}</option>
          </select>
        </div>
        <div>备品:
