  ...
  <div class="warehouseBoard">
    ...
    <div  class="list"  v-if="showViewid==='list'">
      <div class="listHead">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加仓库看板</button>
        </div>
        <div class="ordering">
          <div>
...
export default {
  ...
  methods: {
    ...
    showListView: function () {
      ...
      var self = this
      this.$axios.get('warehouse/board/?ordering=' + self.ordering).then(function (response) {
    ...
    save () {
      ...
      this.$axios.post(`warehouse/board/`, {
    ...
    update () {
      ...
      this.$axios.put(`warehouse/board/` + self.formItem.id + '/', {
        name: self.formItem.name,
        code: self.formItem.code,
        file: self.formItem.file,
        image: self.formItem.image,
    ...
    saveAndSubmit () {
      ...
      this.$axios.post(`warehouse/board/`, {
        ...
        self.formItem.image = []
        self.imageData = []
        self.$axios.patch(`warehouse/board/` + response.data.id + '/', {
          state: '审核中'
        }).then(function (response
        ) {
          alert('数据提交成功')
