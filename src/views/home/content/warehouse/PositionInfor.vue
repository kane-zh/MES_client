  ...
  <div class="positionInfor">
    ...
    <div  class="list"  v-if="showViewid==='list'">
      <div class="listHead">
        ...
        <div class="button" >
          <button type="button" @click="showCreatView"  v-show="canCreate===true">添加仓位信息</button>
        </div>
        <div class="ordering">
          <div>
    ...
    <div  class="detail"  v-show="showViewid==='detail'">
      ...
      <div class="alter" v-if="detail.state!=='闲置'">
        审核信息:
    ...
    <div  class="create"  v-show="showViewid==='create'">
      <form >
        <div>仓位名称:
          <input v-model="formItem.name"  placeholder="请输入仓位名称...">
        </div>
        <div>仓位编码:
          <input v-model="formItem.code"  placeholder="请输入仓位编码...">
